...
#ifdef SOFA_BUILD_SOFA_COMPONENT_ODESOLVER_BACKWARD
#define SOFA_ATTRIBUTE_DISABLED__NEWTONRAPHSON_IN_STATICSOLVER()
#else
#define SOFA_ATTRIBUTE_DISABLED__NEWTONRAPHSON_IN_STATICSOLVER() \
    SOFA_ATTRIBUTE_DISABLED("v25.06", "v25.12", "The Data are defined in the NewtonRaphsonSolver component.")
#endif
