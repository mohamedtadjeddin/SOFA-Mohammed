...
if(NOT TARGET Python::Python)
    if(CMAKE_VERSION VERSION_LESS "3.24.0") 
        find_package(Python 3.12 EXACT QUIET REQUIRED COMPONENTS Interpreter Development)
    else()
        find_package(Python 3.12 EXACT QUIET REQUIRED COMPONENTS Interpreter Development GLOBAL)
    endif()
endif()
...
if(NOT TARGET pybind11)
    ...
    if(CMAKE_VERSION VERSION_LESS "3.24.0") 
        find_package(pybind11 2.11.1 QUIET REQUIRED CONFIG)
    else()
        find_package(pybind11 2.11.1 QUIET REQUIRED CONFIG GLOBAL)
    endif()
