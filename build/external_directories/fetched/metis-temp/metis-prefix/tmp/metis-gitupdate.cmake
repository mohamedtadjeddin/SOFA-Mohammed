...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v5.2.1-ModernInstall"
  WORKING_DIRECTORY "/home/defrost/sofa2/build/external_directories/fetched/metis"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "v5.2.1-ModernInstall")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v5.2.1-ModernInstall" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v5.2.1-ModernInstall")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v5.2.1-ModernInstall\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/defrost/sofa2/build/external_directories/fetched/metis'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/defrost/sofa2/build/external_directories/fetched/metis'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
